...
PGPASSWORD=$9 psql -U $8 -h $6 -p $7 -d ${10} -c "CREATE SCHEMA public;" -c "ALTER SCHEMA public OWNER TO $8;" -c "SET default_tablespace = '';" -c "SET default_table_access_method = heap;"
